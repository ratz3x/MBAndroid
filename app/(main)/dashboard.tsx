  ...
  return (
    <SafeAreaView style={CommonStyles.safeArea} edges={['top']}>
      ...
      >
        ...
        {/* Layanan & Aksi Eksklusif */}
        <View style={{ marginTop: Spacing['2xl'] }}>
          <SectionHeader
            title="Layanan Eksklusif"
            subtitle="Akses cepat fitur keanggotaan & bantuan darurat MBCI"
          />
          <View style={styles.actionList}>
            ...
            >
              <View style={[styles.actionIconBox, styles.actionIconBoxSos]}>
                <Ionicons name="warning" size={20} color="#EF4444" />
              </View>
              <View style={styles.actionTextCol}>
                <View style={styles.sosActionHeaderRow}>
                  <Text style={[styles.actionTitle, { color: '#FFF' }]}>SOS & Roadside Assistance</Text>
                  <View style={styles.sosActionBadge}>
                    <View style={styles.sosLiveDot} />
                    <Text style={styles.sosActionBadgeText}>24 JAM</Text>
                  </View>
                </View>
                <Text style={styles.actionDesc}>Bantuan darurat mogok, derek tol 14080 & bengkel rekanan</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  // SOS Action Card in Layanan Eksklusif
  actionCardSos: {
